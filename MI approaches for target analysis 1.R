#################################################################################
#                                                                               #
#  MI approaches for the analysis model involving an interaction between        #
#  the time-varying exposure and time,evaluated in the paper                    #
...
for (i in 1:length(temp)){
  ...
  MVNImlwide_results.ICC[1,i]=MI_est$var.comp[2,1]/(MI_est$var.comp[2,1]+MI_est$var.comp[1,1]+MI_est$var.comp[3,1])
  MVNImlwide_results.ICC[2,i]=(MI_est$var.comp[2,1]+MI_est$var.comp[1,1])/(MI_est$var.comp[2,1]+MI_est$var.comp[1,1]+MI_est$var.comp[3,1])
...
for (i in 1:length(data)){
  ...
  for(m in 1:M) {
    ...
    datL=reshape(imputed,varying =list(c("prev_dep.3","prev_dep.5","prev_dep.7"),
                                       c("napscore_z.3","napscore_z.5","napscore_z.7")),idvar="c_id", 
                 v.names=c("prev_dep","napscore_z"), times=c(3,5,7),direction= "long")
  ...
  FCSmlwide_results.ICC[1,i]=MI_est$var.comp[2,1]/(MI_est$var.comp[2,1]+MI_est$var.comp[1,1]+MI_est$var.comp[3,1])
  FCSmlwide_results.ICC[2,i]=(MI_est$var.comp[2,1]+MI_est$var.comp[1,1])/(MI_est$var.comp[2,1]+MI_est$var.comp[1,1]+MI_est$var.comp[3,1])
